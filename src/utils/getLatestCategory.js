export async function getLatestCategory(category) {
  try {
    const response = await fetch(
      `https://admin.avgcskills.com/api/content/list?type=STORY&status=PUBLISHED&sort=createdAt&order=desc&category=${category}`,
      {

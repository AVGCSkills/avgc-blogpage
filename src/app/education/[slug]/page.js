...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://avgcframes.com/education/${slug}`,
    },
    openGraph: {
      title: article.base.title,
      description: article.base.description,
      ...
      url: `https://avgcframes.com/education/${slug}`,
      images: [
        {
...
export default async function ArticlePage({ params }) {
  ...
  if (!article || article.payload.category.toLowerCase() !== "education") {
    notFound();
  }
  ...
  // 2. Generate the full text string for the audio player
  ...
  // 3. Dynamic Article Schema (JSON-LD)
  const jsonLd = {
